...
**Jeopardy Counter:** 3 — GM owes teeth. (A long social/strategic stretch w/o blood, loss, or a death-roll; the NEXT concrete scene MUST carry a present above-tier threat or a forced attrition draw — the march, or Shake's solo south-trip into the Shepherd's shadow, will provide it.)

**LIVE (Day +3, night, slipping the column — SNAGGED):** Shake defused the acute suspicion by *complying* (worked the casualty line, acted like a man with nothing to hide; the watchers relaxed), then he + Akhil tried to slip away in the column's chaos. **Botched the slip (roll 9 vs 14):** a lone twitchy **sentry** (one of Vance's, rifle on sling) caught them at the dark edge of camp, bag packed — recognized "the doctor Sarge flagged" — and his **hand is going for the alarm whistle.** No general alarm yet: **one sentry, one second.** Shake's tools are mostly loud (powers = blows the secret to a changed-fearing armed camp). **Vance commits the column NORTH to the Poconos** (1d6→1) — away from the Shepherd; the refugees' testimony carried it over Boyd's push to seize the refuge's silos by force. **Boyd lost the call and filed it** (simmering — not over). **Shake's red line holds** (not toward the Shepherd). **But the new bind:** north (camp's safety) = *away* from Shake's **parents in Newark, DE — which is SOUTH, in the Shepherd's spreading shadow.** Salvation and blood now point opposite on the compass; going to his parents means into the dragon's zone he can't fight. The column is **breaking camp to move north = the chaos-window** to slip off. **Player choosing: ride the safe road north (away from family) or peel off south toward parents (into the Shepherd's shadow).**
...
**Tension:** 6 (+1 — the world dominates: a Warlord-tier mind-Dominator ('the Shepherd') revealed holding the column's destination; the plan poisoned. Regional floor 5.)
...
- **Faction Standing & Rank:** **The Trenton Crossing** (Sgt. **Vance**, ex-Trenton PD). Shake tried to leave (with a Poconos redirect) and **botched it (nat-1):** Vance flatly refused, **moved to detain him + Akhil**, and — worse — got **suspicious of HOW he knew the Shepherd's mind-trap mechanism**, a question mark now hanging over his nature in a changed-fearing camp. **Standing crashed: ++ → hostile/suspect detainee.** Powered secret now at real risk. Two of Vance's people watching them, near rifles.
