...
**LIVE (Day +2/3, on the road, Chester Co. PA — DETAINED):** Shake moved to leave the exodus (he's not wedded to it; family in DE is the goal), giving Vance the truth (refuge = mind-trap) + a redirect (**go north to the Poconos**). **Botched the parting (nat-1):** Vance refused, **is detaining Shake + Akhil**, and grew **suspicious of how he knows the Shepherd's mind-domination mechanism** — a dangerous question mark over his nature in a changed-fearing camp. **Standing crashed to hostile/suspect.** Two armed watchers on them. **The clean exit is gone.** Shake can fly out anytime but that *confirms* he's changed to an armed, fearful crowd (Standing/Exposure disaster). **Player choosing how to get off the leash** (slip away / talk down the suspicion / use Akhil's mind-power / force it & fly / wait for night / other).
