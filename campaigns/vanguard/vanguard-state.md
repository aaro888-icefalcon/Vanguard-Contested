...
**LIVE (Day +3, night, slipping the column — SNAGGED):** Shake defused the acute suspicion by *complying* (worked the casualty line, acted like a man with nothing to hide; the watchers relaxed), then he + Akhil tried to slip away in the column's chaos. **Botched the slip (roll 9 vs 14):** a lone twitchy **sentry** (one of Vance's, rifle on sling) caught them at the dark edge of camp, bag packed — recognized "the doctor Sarge flagged" — and his **hand is going for the alarm whistle.** No general alarm yet: **one sentry, one second.** Shake's tools are mostly loud (powers = blows the secret to a changed-fearing armed camp). Shake's blunt latrine-and-bodyguard bluff **FAILED** (Deception 8 vs 13 — 3rd cold social roll running): the kid didn't buy it, stepped back, and is **bringing the alarm whistle to his lips** ("I'm getting Sarge"). **Razor window — one move before the whole camp wakes.** Quiet options (kinetic grip to crush the whistle/pin him; Akhil mind-reaching to kill the breath in his throat; a hand over his mouth) vs loud (bolt & fly, unmasked over a screaming camp). **Player picking the one move.**
