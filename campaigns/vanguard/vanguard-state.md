...
**LIVE (Day +3, night, slipping the column — SNAGGED):** Shake defused the acute suspicion by *complying* (worked the casualty line, acted like a man with nothing to hide; the watchers relaxed), then he + Akhil tried to slip away in the column's chaos. **Botched the slip (roll 9 vs 14):** a lone twitchy **sentry** (one of Vance's, rifle on sling) caught them at the dark edge of camp, bag packed — recognized "the doctor Sarge flagged" — and his **hand is going for the alarm whistle.** No general alarm yet: **one sentry, one second.** Shake's tools are mostly loud (powers = blows the secret to a changed-fearing armed camp). Shake's escape stalled out: bluff failed, he **called Vance's bluff** (let the kid summon her, brazened the latrine line, showed nothing powered). **Vance's response: stalemate (1d6→3)** — she didn't buy 'latrine' but had nothing to act on; **walked them back, doubled the watch.** Net: **nature-suspicion cooled to a simmer, flight-risk suspicion went hot; secret intact; caged tighter** (deliberate watchers now). Meanwhile the camp is becoming a **powder keg** — word of the mind-trap refuge is spreading, hope curdling to fear among ~1,000 starving people; Vance's real crisis is mounting (and its eventual blow-up = both danger and a future escape window). **Player's move from inside a tightening cage in a fraying camp.**
