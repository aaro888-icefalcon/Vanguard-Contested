...
**LIVE (Day +2/3, on the road south, Chester County PA):** Shake took Vance's hand; the **Trenton Crossing exodus** (~1,000) marched south/SW toward the rumored refuge, Shake as column doctor (Akhil as 'nurse,' muzzling his ring). Half a day in, they met **refugees fleeing the refuge** with the truth: it's **real but seized by 'the Shepherd' — a Warlord-tier mind-DOMINATOR** who took it by turning its people into a smiling flock (above Shake's tier; beats Akhil's whole power-category). **The column's destination is now a will-eating trap; Vance's plan is dead and she's about to ask Shake what to do.** Akhil (quietly, terrified): *that's my power, mastered — and I can't even steer mine.* Shake's parents (Newark, DE) lie *past* the refuge, toward where the Shepherd spreads. **Player's move: what now** (divert the column / scout the refuge / find another safe place / push toward parents / level with or manage Vance / etc.). *Natural chapter break / save point.*
