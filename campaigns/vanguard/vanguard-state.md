...
**LIVE (Day 0, ~12:45, the Hudson's edge, flying in):** Low/careful scout NE went clean — **nothing keyed onto Shake** (caution rewarded; threat roll No). **Recon:** the corridor roads are a **westward refugee flood**; the **GWB and tunnel mouths are solid with people on foot**, crushing at the edges, **no authority anywhere.** Shake can **overfly the chokepoints** (his single biggest edge — 90 sec of open air vs a hundred thousand trapped). **Manhattan ahead is burning in pieces, lightless, no response.** Mount Sinai (Upper East Side) holds maybe-Akhil. **Power self-knowledge gained** (kinetic sense = a momentum/Danger-Sense scout-map through walls; flight tops ~120; one array effect at a time; output runs hot/absorb runs cold-&-feeds-the-Rush). *Jeopardy 2 — the Manhattan entry must bite.*
