...
**LIVE (Day 0, ~13:00, outside Mount Sinai, Upper East Side):** Shake **overflew the Hudson** (skipping the choked crossings), landed discreetly in **Central Park's North Woods**, ditched the outer coat & hood, and walked out as a nobody — **landing stayed clean (no one connected him; Exposure held at 4/6).** Walking to the hospital he hit the city's toll: **Mount Sinai is besieged by a crush of thousands** — no power, no staff visible, no triage, the desperate carrying the hurt, people being **crushed to death against the building face** (his kinetic sense reads the killing pressure-zones). **Akhil**, if alive & if he stayed, is inside or under it. Shake (blending; field shrugs force; could fly/Move-Object but that = becoming "the flying man" before 10,000 panicked people) must decide how to reach his brother. *Jeopardy 2 — teeth present (lethal crush).*
...
**Date / Location / Region band:** **Day +0, ~12:45 Eastern** · at the **Hudson's edge**, about to cross into **Manhattan** (burning, lightless, abandoned); the crossings below choked with a westward refugee flood. Bound for **Mount Sinai (Upper East Side)** & Akhil · **Mid-Atlantic Corridor — Embattled at Day Zero** (Tension floor 5).
