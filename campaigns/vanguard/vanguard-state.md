...
**LIVE (Day +2 night → the deal, Trenton Crossing):** Shake's exit was refused (Vance, decent/immovable), so he **reframed it strategically** (Persuasion 23): the bridge is untenable — where's she taking these people? Vance opened up: ~10 days of order left, and a plan to move **south/SW (Chester County PA → toward the Delaware line)** toward a **rumored refuge** — walls, power returning, grown food: maybe a **redoubt** (first rumor of the world rebuilding). **Her road = Shake's road south.** **DEAL:** Shake (+ Akhil) serve as the **column's doctor** to move & keep ~1,000 starving refugees alive on the march; in exchange, free passage + supplies + Vance's blessing + a clear path to his parents (Newark, DE is on the way). Cage → caravan. **Risks ahead:** a slow, vulnerable, hungry exodus through an Embattled corridor; Shake's powered secret riding inside a changed-fearing column for days; a refuge no one's actually seen. **Player: accept the deal & set how to play the road south.**
...
**Tension:** 5 (−1 — Shake turned the cage into an alliance heading his own way; regained control. Regional floor 5.)
...
3b. **The rumored refuge (redoubt?)** — talk on the road of a real safe-zone south/SW (Chester County PA → Delaware line): walls, returning power, grown food, real organization. Unverified. Possibly the leading edge of the canon redoubt/Recovery. The exodus's destination. *(opened Day +2)*
...
- **Faction Standing & Rank:** **The Trenton Crossing** (Sgt. **Vance**, ex-Trenton PD; first-responder refuge, now mobilizing into a **southbound exodus** toward a rumored refuge). Traits: disciplined/decent-but-hard; **fears the changed**; **food-strained**. Shake's standing: **++ (trusted strategic partner + the column's doctor)** after reframing her crisis & cutting a road-south deal. **Powered status still concealed** (a changed-fearing column; exposure would shatter this). Rank: informal — Vance's right hand on medical/planning.
