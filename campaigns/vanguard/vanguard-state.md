...
**Jeopardy Counter:** 2 (cleverly turned the cage into a partnership — but two no-hard-cost beats; the road-south exodus must open with lethal stakes / a scarcity bite).

**LIVE (Day +3, night, slipping the column — SNAGGED):** Shake defused the acute suspicion by *complying* (worked the casualty line, acted like a man with nothing to hide; the watchers relaxed), then he + Akhil tried to slip away in the column's chaos. **Botched the slip (roll 9 vs 14):** a lone twitchy **sentry** (one of Vance's, rifle on sling) caught them at the dark edge of camp, bag packed — recognized "the doctor Sarge flagged" — and his **hand is going for the alarm whistle.** No general alarm yet: **one sentry, one second.** Shake's tools are mostly loud (powers = blows the secret to a changed-fearing armed camp). Shake's escape stalled (bluff failed → bluff-called → stalemate): caged tighter, watch doubled, secret intact, flight-risk suspicion hot / nature-suspicion cooled. He spent cage-time **mapping the camp's notables** (Vance, Boyd, Marian, Hollis, Tomas — see Character list). **Camp is a powder keg with a lit fuse: Tomas's larder = ~2 days; Boyd (hardliner) is circling Vance's authority; the mind-trap destination has hope curdling to fear.** When the food hits zero (~2 days) OR Boyd sparks it, the decent ordered camp becomes something else — danger *and* the chaos-window Shake wanted. No hidden powered here; no one onto Shake yet. **Player working the time/terrain before the count hits zero.**
