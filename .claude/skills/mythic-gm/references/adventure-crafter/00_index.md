...
- **Plotlines = Threads** (interchangeable). Use Mythic 2e List rules.
...
|---|---|---|
| Turning Point (roll Plotline → 2–5 Plot Points) | "Turning Points And Plot Points" | `adventure_crafter.py turning-point` |
...
| Plotlines & Characters Lists, "List Is Full" | "Lists And The Adventure Sheet" | `oracle.py list` |
